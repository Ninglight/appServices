            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="information" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        @if ($question->information)
                            ...
                            <form class="row" method="post" action="{{ action('InformationController@update', $question->information->id) }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <input name="_method" type="hidden" value="PATCH">
                                ...
                                <div class="mt-4 mb-4 d-flex justify-content-between col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-primary ">Mettre à jour l'information</button>
                                </div>
                        ...
                        @else
                            ...
                            <form class="row" method="post" action="{{ url('/admin/informations') }}" enctype="multipart/form-data">
                                @csrf
