                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="exampleInputTitle"
                                                   ...
                                                   name="value" required value="{{ $default_value->value }}" placeholder="Valeur">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="exampleInputTitle"
                                                   aria-describedby="nameHelp"
                                                   name="identification" required value="{{ $default_value->identification }}" placeholder="Identifiant">
                                        </div>
                                    </td>
